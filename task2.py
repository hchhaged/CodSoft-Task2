...
LARGE_FONT_STYLE = ("VERDANA", 40)
SMALL_FONT_STYLE = ("VERDANA", 16)
DIGITS_FONT_STYLE = ("VERDANA", 24)
...
class Calculator:
    ...
    def create_operator_buttons(self):
        ...
        for operator, symbol in self.operations.items():
            button = tk.Button(self.buttons_frame, text=symbol, bg=ODD, fg=GREEN, font=DEFAULT_FONT_STYLE,
    ...
    def create_clear_button(self):
        button = tk.Button(self.buttons_frame, text="C", bg=ODD, fg=RED, font=DEFAULT_FONT_STYLE,
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2", bg=ODD, fg=GREEN, font=DEFAULT_FONT_STYLE,
